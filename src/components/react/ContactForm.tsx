...
export default function ContactForm() {
    ...
    return (
        <section id="contact-section" className="mt-10 scroll-mt-20 w-full">
            {/* Section Header */}
            <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-stretch">
                ...
                <div className="md:col-span-2 flex flex-col gap-4">
                    <Card className="bg-card/30 h-full overflow-hidden border-border/50">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-xs mt-1">
                                        ...
                                        <a href="mailto:helmiarimbawa46@gmail.com" className="text-primary hover:underline">
                                            helmiarimbawa46@gmail.com
                                        </a>
                                    </p>
                                </div>
                            </div>
                ...
                <div className="md:col-span-3">
                    <Card className="bg-card/30 h-full border-border/50">
                        <CardHeader>
                            <CardTitle className="text-lg flex items-center gap-2">
